...
mask_image = "assets/combination_1/cat_mask.png"
...
# inversion_image = np.array(load_image(args.reference_image1_path).resize((1024, 1024)))
image = load_image(args.reference_image1_path)
...
image = Image.open(args.reference_image1_path).convert("RGB")   
